...
interface SidebarDefinition extends FoundationElementDefinition {
  // defaultButtonContent?: string;
}

export class Sidebar extends FoundationElement {
  connectedCallback(): void {
    ...
    fillColor.setValueFor(this, neutralLayer4);
  }
}

export const demoSidebar = Sidebar.compose<SidebarDefinition>({
  baseName: "sidebar",
  template,
  styles,
});
